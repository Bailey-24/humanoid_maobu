...
```
example `python scripts/csv_to_npz.py --input_file  ./LAFAN1_Retargeting_Dataset/g1/dance1_subject1.csv --input_fps 30 --output_name dance1_subject1`
...
```
i.e. `python scripts/replay_npz.py --registry_name=bailey808-org-org/wandb-registry-motions/dance1_subject1`

- Debugging
    - Make sure to export WANDB_ENTITY to your organization name, not your personal username. `export WANDB_ENTITY=bailey808-org`
...
i.e. 
```bash
python scripts/rsl_rl/train.py --task=Tracking-Flat-G1-v0 \--registry_name  bailey808-org-org/wandb-registry-motions/dance1_subject1 --logger wandb --log_project_name test_whole_body_tracking --run_name test_dance1_subject1
```
...
eval from local: 
```bash
python scripts/rsl_rl/play_local.py --local_wandb_path ./wandb/run-20250912_193754-q89nf0on  --task=Tracking-Flat-G1-v0 --motion_file /home/ubuntu/projects/whole_body_tracking/artifacts/dance1_subject1:v0/motion.npz
```
